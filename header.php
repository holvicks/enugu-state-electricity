  ...
  <div class="flex px-[40px] md:px-[10px]  lg:px-[100px]">
    <div class="max-w-screen-2xl mx-auto w-full py-4 block">
      <div class="flex items-center justify-between w-full">
        <div class=""><a href="/">
        <img src="./assets/images/logo.svg" alt="logo" class="scale-110"></a>
        </div>
        <div class="items-center hidden md:flex">
          <a class="font-red-hat font-bold text-[16px] leading-[15.52px] tracking-[-0.16px] mr-6" href="/">Home</a>
          <nav aria-label="Main" data-orientation="horizontal" dir="ltr" class="z-10 flex max-w-max flex-1 items-center justify-center">
            <div style="position: relative;">
              <ul data-orientation="horizontal" class="group flex flex-1 list-none items-center justify-center space-x-1 w-min" dir="ltr">


                                 <!--about us toggle -->
                <nav id="about-us-toggle" aria-label="Main" data-orientation="vertical" dir="ltr" class="z-10 flex max-w-max flex-1 items-center justify-center">
                  <div style="position: relative;">
                    <ul data-orientation="vertical" class="group flex flex-1 list-none items-center justify-center space-x-1 w-min" dir="ltr">
                      <li class="relative flex justify-center">
                        <div class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-transparent hover:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-transparent data-[state=open]:bg-transparent group relative inline-flex items-center">
                          <div class="mr-1">
                            <p class="font-red-hat font-normal text-[16px] leading-[15.52px] tracking-[-0.16px] cursor-pointer">About us</p>
                          </div>
                ...
                <ul class="hidden absolute left-0 min-w-[200px] rounded-lg p-7 top-full z-1 bg-white flex flex-col gap-6 transition-opacity duration-300" id="about-us-menu">
                <li class="w-full"><a class="block whitespace-nowrap hover:bg-gray-100 hover:text-gray-800 px-2 py-2 rounded-sm w-full text-left" href="./about.php">About Us</a></li>
          ...
          <nav id="regulatory-toggle" aria-label="Main" data-orientation="horizontal" dir="ltr" class="z-10 flex max-w-max flex-1 items-center justify-center">
            <div style="position: relative;">
              <ul data-orientation="horizontal" class="group flex flex-1 list-none items-center justify-center space-x-1 w-min" dir="ltr">
                <nav aria-label="Main" data-orientation="vertical" dir="ltr" class="z-10 flex max-w-max flex-1 items-center justify-center">
                  <div style="position: relative;">
                    <ul data-orientation="vertical" class="group flex flex-1 list-none items-center justify-center space-x-1 w-min" dir="ltr">
                      <li class="relative flex justify-center">
                      <div class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-transparent hover:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-transparent data-[state=open]:bg-transparent group relative inline-flex items-center" id="radix-:r4:-trigger-radix-:r5:" data-state="closed" aria-expanded="false" aria-controls="radix-:r4:-content-radix-:r5:" data-radix-collection-item="">
                        <div class="mr-1">
                          <p class="font-red-hat font-normal text-[16px] leading-[15.52px] tracking-[-0.16px] cursor-pointer">Regulatory Instruments</p>
                        </div>
        ...
        <!--end of Regulatory Instrument-->
        <a class="font-red-hat font-normal text-[16px] leading-[15.52px] tracking-[-0.16px] cursor-pointer" href="/legal-instruments">Legal Instruments</a>


        <nav id="media-toggle" aria-label="Main" data-orientation="horizontal" dir="ltr" class="z-10 flex max-w-max flex-1 items-center justify-center">
          <div style="position: relative;">
            <ul data-orientation="horizontal" class="group flex flex-1 list-none items-center justify-center space-x-1 w-min" dir="ltr">
              <nav aria-label="Main" data-orientation="vertical" dir="ltr" class="z-10 flex max-w-max flex-1 items-center justify-center">
                <div style="position: relative;">
                  <ul data-orientation="vertical" class="group flex flex-1 list-none items-center justify-center space-x-1 w-min" dir="ltr">
                    <li class="relative flex justify-center">
                      <div class="group inline-flex h-10 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium transition-colors hover:bg-transparent hover:text-accent-foreground focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[active]:bg-transparent data-[state=open]:bg-transparent group relative inline-flex items-center" id="radix-:r7:-trigger-radix-:r8:" data-state="closed" aria-expanded="false" aria-controls="radix-:r7:-content-radix-:r8:" data-radix-collection-item="">
                        <div class="mr-1">
                          <p class="font-red-hat font-normal text-[16px] leading-[15.52px] tracking-[-0.16px] cursor-pointer">Media</p>
                        </div>
            ...
            <ul class="bg-[#F8F8F8] hidden absolute lg:left-[-20px]   min-w-[300px] rounded-lg p-7 top-full
            grid grid-cols-2"
            id="media-menu">
      ...
      <div style="opacity: 1;"><div>
        <div class="hidden md:block" tabindex="0" style="transform: none;">
          <a href="/contact-us">
            <button class="inline-flex text-white items-center justify-center whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-[#FC6d06] text-primary-foreground hover:bg-[#FC6d06]/90 h-10 cursor-pointer rounded-lg font-bold text-[16px] leading-[15.52px] tracking-[-0.64px] font-red-hat px-8 py-7">Contact us</button>
          </a>
        </div>
        <!--======menu toggle=======-->
        <div id="menu-toggle" class="md:hidden flex flex-col gap-y-1.5 cursor-pointer" type="button" aria-haspopup="dialog" aria-expanded="false" aria-controls="radix-:r9:" data-state="closed">
          <span class="block h-[0.2rem] rounded-full w-7 bg-black"></span>
          <span class="block h-[0.2rem] rounded-md w-5 bg-black"></span>
        </div>
        <div class=""></div>
      </div>
    </div>
...
<ul id="mobile-nav" class="md:hidden bg-white  z-50 h-screen fixed w-full top-0  h-full bottom-0 py-24 pl-4 duration-500 hidden ">
        <div class="md:px-0 py-5 md:w-auto w-full flex justify-between">
            ...
            <div class=""><a class="w-1/2 py-2 text-[20px]" type="button" href="/">Home</a></div> </div>
                <div>
                    <h3 class="flex">
